...
contract DAOFounderMiningV1 is ERC1155BurnMiningV1 {
        ...
        override
    {
        ...
        _registerInterface(DAOFounderMiningV1(0).founderMining.selector);
    ...
    function founderMining() external pure returns (bool) {
        return true;
    }
}
