...
import {
    DAOFounderMiningV1 as _DAOFounderMiningV1
} from "../../../core/emission/pools/DAOFounderMiningV1.sol";
...
library PoolType {
    ...
    bytes4 public constant DAOFounderMiningV1 =
        _DAOFounderMiningV1(0).founderMining.selector;
}
